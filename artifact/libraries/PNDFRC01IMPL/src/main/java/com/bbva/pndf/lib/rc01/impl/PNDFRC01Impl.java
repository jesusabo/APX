...
import com.bbva.pndf.dto.student.EstadoMatriculaDTO;
...
public class PNDFRC01Impl extends PNDFRC01Abstract {
	...
	private static final String ERR_PROCESS_DB = "No query";
	private static final String ERR_NO_RESULTS = "No resultado";
	private static final String ID = "id";
	private static final String GRADO = "grado";
	private static final String ESTADO_NO_MATRICULADO = "No matriculado";
	private static final String ESTADO_MATRICULA = "estado_matricula";
	...
	public ResponseStudentDTO executeGetStudent(String id, String grado) {
		...
		try {
			...
			if(!objResponseSQL.isEmpty() && objResponseSQL.size()>0){
				EstadoMatriculaDTO estadoMatriculaDTO = new EstadoMatriculaDTO((String) objResponseSQL.get("ESTADO_MATRICULA"));
				if(estadoMatriculaDTO.getEstadoMatricula().equals(ESTADO_NO_MATRICULADO)){
